	...
	while True:
		...
		if (msg.arbitration_id == US1) :
			...
			if (distance > 50):
                ...
                msg = can.Message(arbitration_id=0x010,data=[0x00,0x00,0x00, 0x00, 0x00, 0x00,0x41,0x19],extended_id=False) # tourner un peu gauche
			    bus.send(msg)
		...
		if (msg.arbitration_id == US2) and (obstacle==False):
			...
			if distance > 50:
				...
				msg = can.Message(arbitration_id=0x010,data=[0x00,0x00,0x00, 0x00, 0x00, 0x00,0x41,0x4B],extended_id=False) # tourner un peu a droite
			    bus.send(msg)
